  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-indigo-900 to-black text-white">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-96">
        <h2 className="text-3xl font-extrabold text-center text-indigo-400 mb-6">Crear Cuenta</h2>
        ...
        <p className="text-center text-gray-400 mt-4">
          ¿Ya tienes cuenta? <a href="/login" className="text-indigo-400 hover:underline">Inicia sesión aquí</a>
        </p>
      </div>
    </div>
  );
